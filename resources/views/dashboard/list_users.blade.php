...
@section('content')
    <div class="form-container">
        ...
        <div class="exper_info ">
            <h3 class="d-inline">Users </h3> <a class="add add_exp " href="/add_user"> <i class="far fa-plus"></i> New</a>
            ...
            <tbody>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            @if ($item['is_active'] == 1)
                                <a href="update_user/{{ $item['id'] }}" class=" edit btn "><i
                                        class="fas fa-edit"></i></a><a
                                    href="activate_user/{{ $item['id'] }}/{{ $item['is_active'] }}"
                                    class="btn  text-danger"><i class="fas fa-trash-alt"></i></a>
                            @else
                                <a href="update_user/{{ $item['id'] }}" class=" edit btn "><i
                                        class="fas fa-edit"></i></a><a
                                    href="activate_user/{{ $item['id'] }}/{{ $item['is_active'] }}" class="btn  "
